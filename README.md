...
- [**Swift-Style-Guide**](#swift-style-guide)
  ...
  - [风格](#%E9%A3%8E%E6%A0%BC)
    ...
    - [Guard 关键字](#guard-%E5%85%B3%E9%94%AE%E5%AD%97)
...
- [**API Design Guidelines**](#api-design-guidelines)
  ...
  - [约定](#%E7%BA%A6%E5%AE%9A)
    ...
    - [参数标签（参数外部名）](#%E5%8F%82%E6%95%B0%E6%A0%87%E7%AD%BE%E5%8F%82%E6%95%B0%E5%A4%96%E9%83%A8%E5%90%8D)
...
属性和函数注释可以直接使用快捷键 `⌘ + ⌥ + /` 得到 `///`，方便生成文档和 Option键 + 左键查看注释。虽然 `//` 也被视为注释，但是这种语法会被 Xcode 忽略，而不产生对应的代码文档，所以尽量只在各种代码块中可以使用 `//` 来注释。
